...
/* First created by JCasGen Sat Oct 26 11:25:30 EDT 2013 */
package edu.cmu.lti.f13.hw4.hw4_chenyinh.typesystems;
...
/** 
 * Updated by JCasGen Sat Oct 26 11:25:34 EDT 2013
 * XML source: /home/houcy/git/hw4-chenyinh/hw4-chenyinh/src/main/resources/descriptors/typesystems/VectorSpaceTypes.xml
 * @generated */
public class Document extends Annotation {
  ...
  public int getRelevanceValue() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_relevanceValue == null)
      jcasType.jcas.throwFeatMissing("relevanceValue", "edu.cmu.lti.f13.hw4.hw4_chenyinh.typesystems.Document");
  ...
  public int getQueryID() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_queryID == null)
      jcasType.jcas.throwFeatMissing("queryID", "edu.cmu.lti.f13.hw4.hw4_chenyinh.typesystems.Document");
  ...
  public String getText() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_text == null)
      jcasType.jcas.throwFeatMissing("text", "edu.cmu.lti.f13.hw4.hw4_chenyinh.typesystems.Document");
  ...
  public FSList getTokenList() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_tokenList == null)
      jcasType.jcas.throwFeatMissing("tokenList", "edu.cmu.lti.f13.hw4.hw4_chenyinh.typesystems.Document");
