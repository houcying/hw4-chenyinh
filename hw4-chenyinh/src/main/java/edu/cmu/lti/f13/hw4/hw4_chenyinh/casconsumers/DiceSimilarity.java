...
public class DiceSimilarity extends Similarity {
  ...
  public double computeScore(Map<String, Integer> queryVector, Map<String, Integer> docVector) {
    ...
    jaccard_similarity = 2 * unionnumber / (unionnumber + length(docVector) + length(queryVector));
    return jaccard_similarity;

  }

  @Override
  /* Dicesimilarity evalute the length of a vector as the total number of tokens */
